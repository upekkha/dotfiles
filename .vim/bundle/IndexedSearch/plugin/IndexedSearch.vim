...
nnoremap <silent>n :let v:errmsg=''<cr>:silent! norm! nzv<cr>:call <SID>ShowCurrentSearchIndex(0,'!')<cr>zx
nnoremap <silent>N :let v:errmsg=''<cr>:silent! norm! Nzv<cr>:call <SID>ShowCurrentSearchIndex(0,'!')<cr>zx
nnoremap <silent>* :let v:errmsg=''<cr>:silent! norm! *zv<cr>:call <SID>ShowCurrentSearchIndex(0,'!')<cr>zx
nnoremap <silent># :let v:errmsg=''<cr>:silent! norm! #zv<cr>:call <SID>ShowCurrentSearchIndex(0,'!')<cr>zx
